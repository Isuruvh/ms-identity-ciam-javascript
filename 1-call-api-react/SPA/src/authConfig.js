...
const tenantAuthority = process.env.REACT_APP_TENANT_AUTHORITY || '';
const apiClientId = process.env.REACT_APP_API_CLIENT_ID || '';
const apiEndpoint = process.env.REACT_APP_API_ENDPOINT || 'https://localhost:44351/api/todolist';
...
export const msalConfig = {
    auth: {
        ...
        authority: tenantAuthority, // Replace the placeholder with your tenant subdomain
...
export const protectedResources = {
    toDoListAPI: {
        ...
        scopes: {
            read: [`api://${apiClientId}/ToDoList.Read`],
            write: [`api://${apiClientId}/ToDoList.ReadWrite`],
        },
    },
};
