...
var apiInstance = Environment.GetEnvironmentVariable("AZURE_AD_INSTANCE");
...
if (!string.IsNullOrWhiteSpace(apiInstance))
{
    builder.Configuration["AzureAd:Instance"] = apiInstance;
}
